...
public class ItemPatCD2 extends ItemRecord
{
 ...
 public ItemPatCD2(String recordName)
 {
 super(recordName);
 ...
 public static ItemPatCD2 getRecord(String par0Str)
 {
 return (ItemPatCD2)records.get(par0Str);
 }
