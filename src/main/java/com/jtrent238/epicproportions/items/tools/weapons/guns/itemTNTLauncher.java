...
list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemTNTLauncher"+ "." + "ammotype" ));
 }
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Item.getItemById(46)))
        {
            ...
            EntityTNTPrimed entityarrow = new EntityTNTPrimed(par2World)
            {
...
//world.createExplosion((Entity)null, i, j, k, 4F, true);
            	...
            	par2World.playSoundAtEntity(par3EntityPlayer, EpicProportionsMod.MODID + ":TNTLauncher_boom", 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
