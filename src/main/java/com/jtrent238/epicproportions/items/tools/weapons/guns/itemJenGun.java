...
public class itemJenGun extends Item{
...
list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemJenGun"+ "." + "ammotype" ));
 }
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(ItemLoader.itemJenArrow))
        {
            float f = 100.0F;

            EntilyJenArrow entityarrow = new EntilyJenArrow(par2World, par3EntityPlayer, f * 2.0F)
            {
...
//world.createExplosion((Entity)null, i, j, k, 4F, true);
            ...
            {
                par3EntityPlayer.inventory.consumeInventoryItem(ItemLoader.itemJenArrow);
            }
