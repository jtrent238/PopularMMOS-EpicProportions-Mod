...
public class itemFartBombLauncher extends Item{

public itemFartBombLauncher(){
super();
setMaxDamage(100);
maxStackSize = 1;
setFull3D();
...
list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemFartBombLauncher"+ "." + "ammotype" ));
 }
...
//world.createExplosion((Entity)null, i, j, k, 4F, true);
            	...
            	par2World.playSoundAtEntity(par3EntityPlayer, EpicProportionsMod.MODID + ":FartBombLauncher_boom", 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
