...
public class itemTrollTNTLauncher extends Item{

public itemTrollTNTLauncher(){
super();
setMaxDamage(100);
maxStackSize = 1;
setFull3D();
...
list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemTrollTNTLauncher"+ "." + "ammotype" ));
 }
...
public int getMaxItemUseDuration(ItemStack par1ItemStack)
   ...
   public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, final EntityPlayer par3EntityPlayer){
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Item.getItemById(46)))
        {
            ...
            EntilyTrollTNTPrimed entityarrow = new EntilyTrollTNTPrimed(par2World)
            {
...
//world.createExplosion((Entity)null, i, j, k, 4F, true);
            	...
            	par2World.playSoundAtEntity(par3EntityPlayer, EpicProportionsMod.MODID + ":TrollTNTLauncher_boom", 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
