...
public class itemBirthdayPresent_Bad extends Item
{
    private static final String __OBFID = "CL_00001771";
	
	

    public itemBirthdayPresent_Bad()
    {
    ...
    @Override
	 ...
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemBirthdayPresent_Bad" + "." + "bday"));
	 list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemBirthdayPresent_Bad" + "." + "inside"));
	  }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            blockBirthdayPresent_Bad present = (blockBirthdayPresent_Bad)BlockLoader.blockBirthdayPresent_Bad;
