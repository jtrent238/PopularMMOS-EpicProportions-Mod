...
public class itemBirthdayPresent_Green extends Item
{
    private static final String __OBFID = "CL_00001771";
	
	

    public itemBirthdayPresent_Green()
    {
    ...
    @Override
	 ...
	 list.add(EnumChatFormatting.GOLD + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemBirthdayPresent_Green" + "." + "bday"));
	 list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "itemBirthdayPresent_Green" + "." + "inside"));
	  }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            blockBirthdayPresent_Green present = (blockBirthdayPresent_Green)BlockLoader.blockBirthdayPresent_Green;
