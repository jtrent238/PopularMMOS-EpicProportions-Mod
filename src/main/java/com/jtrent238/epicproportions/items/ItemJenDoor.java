...
import com.jtrent238.epicproportions.DoorType;
...
public class ItemJenDoor extends Item
{
    private Material doorMaterial;
	private DoorType DoorType;
    private static final String __OBFID = "CL_00000020";

    public ItemJenDoor(Material p_i45334_1_)
    {
