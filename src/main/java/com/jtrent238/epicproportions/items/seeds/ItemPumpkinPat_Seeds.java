package com.jtrent238.epicproportions.items.seeds;
...
public class ItemPumpkinPat_Seeds extends Item implements IPlantable
{
    ...
    public ItemPumpkinPat_Seeds(Block p_i45352_1_, Block p_i45352_2_)
    {
