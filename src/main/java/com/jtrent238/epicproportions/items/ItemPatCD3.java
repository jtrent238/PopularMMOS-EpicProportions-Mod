...
public class ItemPatCD3 extends ItemRecord
{
 ...
 public ItemPatCD3(String recordName)
 {
 super(recordName);
 ...
 public static ItemPatCD3 getRecord(String par0Str)
 {
 return (ItemPatCD3)records.get(par0Str);
 }
