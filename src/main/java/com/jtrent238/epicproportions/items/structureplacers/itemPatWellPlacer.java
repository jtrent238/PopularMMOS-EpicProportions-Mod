...
public class itemPatWellPlacer extends Item{



public itemPatWellPlacer(int par1){
setMaxDamage(0);
maxStackSize = 1;
setUnlocalizedName("itemPatWellPlacer");
setTextureName("epicproportionsmod:itemPatWellPlacer");
