...
public class itemJensHoleStructurePlacer_1  extends Item{

public itemJensHoleStructurePlacer_1(int par1){
setMaxDamage(0);
maxStackSize = 1;
}
...
if(place){
		...
		//world.setBlock(i+2, j+1, k+1, Block.getBlockById(1), 0, 2);
		world.setBlock(i+0, j+1, k+2, Block.getBlockById(0), 0, 2);
		//world.setBlock(i+1, j+1, k+2, Block.getBlockById(1), 0, 2);
		...
		//world.setBlock(i+2, j+2, k+1, Block.getBlockById(1), 0, 2);
		world.setBlock(i+0, j+2, k+2, Block.getBlockById(0), 0, 2);
		//world.setBlock(i+1, j+2, k+2, Block.getBlockById(1), 0, 2);
		...
		//world.setBlock(i+2, j+3, k+0, Block.getBlockById(1), 0, 2);
