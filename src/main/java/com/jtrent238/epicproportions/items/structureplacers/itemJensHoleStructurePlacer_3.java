...
public class itemJensHoleStructurePlacer_3   extends Item{

public itemJensHoleStructurePlacer_3(int par1){
setMaxDamage(0);
maxStackSize = 1;
}
...
if(place){
	...
	//world.setBlock(i+0, j+0, k+1, Block.getBlockById(3), 0, 2);
	...
	//world.setBlock(i+2, j+0, k+3, Block.getBlockById(3), 0, 2);
	...
	//world.setBlock(i+1, j+0, k+4, Block.getBlockById(3), 0, 2);
	//world.setBlock(i+2, j+0, k+4, Block.getBlockById(2), 0, 2);
	//world.setBlock(i+3, j+0, k+4, Block.getBlockById(12), 0, 2);
	...
	//world.setBlock(i+4, j+1, k+1, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+1, k+2, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+1, k+3, Block.getBlockById(1), 0, 2);
	world.setBlock(i+0, j+1, k+4, Block.getBlockById(0), 0, 2);
	//world.setBlock(i+1, j+1, k+4, Block.getBlockById(1), 0, 2);
	//world.setBlock(i+2, j+1, k+4, Block.getBlockById(1), 0, 2);
	//world.setBlock(i+3, j+1, k+4, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+2, k+1, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+2, k+2, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+2, k+3, Block.getBlockById(1), 0, 2);
	world.setBlock(i+0, j+2, k+4, Block.getBlockById(0), 0, 2);
	//world.setBlock(i+1, j+2, k+4, Block.getBlockById(1), 0, 2);
	//world.setBlock(i+2, j+2, k+4, Block.getBlockById(1), 0, 2);
	//world.setBlock(i+3, j+2, k+4, Block.getBlockById(1), 0, 2);
	...
	//world.setBlock(i+4, j+3, k+0, Block.getBlockById(1), 0, 2);
