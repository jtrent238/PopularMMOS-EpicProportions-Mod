...
public class ItemPatCD1 extends ItemRecord
{
 ...
 public ItemPatCD1(String recordName)
 {
 super(recordName);
 ...
 public static ItemPatCD1 getRecord(String par0Str)
 {
 return (ItemPatCD1)records.get(par0Str);
 }
