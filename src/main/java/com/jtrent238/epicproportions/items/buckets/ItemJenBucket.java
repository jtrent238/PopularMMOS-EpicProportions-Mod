package com.jtrent238.epicproportions.items.buckets;
...
public class ItemJenBucket extends Item
{
    /** field for checking if the bucket has been filled. */
    private Block isFull;
    private static final String __OBFID = "CL_00000000";

    public ItemJenBucket(Block p_i45331_1_)
    {
        this.maxStackSize = 1;
            ...
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (flag)
                {
                    ...
                    if (material == Material.water && l == 0)
                    {
                        ...
                        return this.func_150910_a(p_77659_1_, p_77659_3_, ItemLoader.ItemJenBucket_water);
                    }

                    if (material == Material.lava && l == 0)
                    {
                        p_77659_2_.setBlockToAir(i, j, k);
                        return this.func_150910_a(p_77659_1_, p_77659_3_, ItemLoader.ItemJenBucket_lava);
                    }
                }
                else
                {
                    ...
                    {
                        return new ItemStack(ItemLoader.ItemJenBucket);
                    }
