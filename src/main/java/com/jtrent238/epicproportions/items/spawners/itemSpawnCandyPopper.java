...
public class itemSpawnCandyPopper   extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityCandyPopper par1 = new EntityCandyPopper(world); //Just change"MyEntityCow" to any entity you would like to spawn
