...
public class itemSpawnCaptianCookie extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityCaptianCookie par1 = new EntityCaptianCookie(world); //Just change"MyEntityCow" to any entity you would like to spawn
