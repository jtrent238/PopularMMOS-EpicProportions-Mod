...
public class itemSpawnPatVillager        extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityVillager par1 = new EntityVillager(world, 24); //Just change"MyEntityCow" to any entity you would like to spawn
