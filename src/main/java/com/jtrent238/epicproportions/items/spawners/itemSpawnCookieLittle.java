...
public class itemSpawnCookieLittle extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityCaptianCookieLittle par1 = new EntityCaptianCookieLittle(world); //Just change"MyEntityCow" to any entity you would like to spawn
