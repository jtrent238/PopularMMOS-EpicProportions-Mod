...
public class itemSpawnBlockling       extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityBlockling_Small par1 = new EntityBlockling_Small(world); //Just change"MyEntityCow" to any entity you would like to spawn
