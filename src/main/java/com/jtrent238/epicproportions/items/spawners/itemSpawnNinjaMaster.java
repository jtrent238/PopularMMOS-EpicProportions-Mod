...
public class itemSpawnNinjaMaster extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityNinjaMaster par1 = new EntityNinjaMaster(world); //Just change"MyEntityCow" to any entity you would like to spawn
