...
import com.jtrent238.epicproportions.inventory.ContainerPatChest;
...
public class TileEntityPatChest extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[36];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPatChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPatChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPatChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityPatChest adjacentChestZPos;
    ...
    public TileEntityPatChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityPatChest(int p_i2350_1_)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.Patchest";
    }
    ...
    private void func_145978_a(TileEntityPatChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityPatChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityPatChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityPatChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityPatChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        else
        {
            ...
            return block instanceof blockPatChest && ((blockPatChest)block).field_149956_a == this.func_145980_j();
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (entityplayer.openContainer instanceof ContainerPatChest)
                {
                    IInventory iinventory = ((ContainerPatChest)entityplayer.openContainer).getLowerChestInventory();

                    if (iinventory == this || iinventory instanceof InventoryLargePatChest && ((InventoryLargePatChest)iinventory).isPartOfLargeChest(this))
                    {
    ...
    {
        if (this.getBlockType() instanceof blockPatChest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof blockPatChest))
            {
                return 0;
            }

            this.cachedChestType = ((blockPatChest)this.getBlockType()).field_149956_a;
        }
