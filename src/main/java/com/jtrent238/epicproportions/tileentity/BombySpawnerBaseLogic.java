...
public abstract class BombySpawnerBaseLogic 
{
    /** The delay to spawn. */
    ...
    public void readFromNBT(NBTTagCompound p_98270_1_)
    {
        ...
        if (p_98270_1_.hasKey("SpawnPotentials", 9))
        {
            ...
            {
                this.potentialEntitySpawns.add(new BombySpawnerBaseLogic.WeightedRandomMinecart(nbttaglist.getCompoundTagAt(i)));
            }
        }
        else
        {
        ...
        {
            this.setEntityName(entityTypeName);
        }
        else
        {
    ...
    public net.minecraft.tileentity.MobSpawnerBaseLogic.WeightedRandomMinecart getRandomEntity()
    {
