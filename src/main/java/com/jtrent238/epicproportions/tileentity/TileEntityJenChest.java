...
import com.jtrent238.epicproportions.inventory.ContainerJenChest;
...
public class TileEntityJenChest extends TileEntity implements IInventory
{
    ...
    public TileEntityJenChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityJenChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityJenChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityJenChest adjacentChestZPos;
    ...
    public TileEntityJenChest(int p_i2350_1_)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "container.Jenchest";
    }
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityJenChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityJenChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityJenChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityJenChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        else
        {
            ...
            return block instanceof blockJenChest && ((blockJenChest)block).field_149956_a == this.func_145980_j();
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + this.xCoord + this.yCoord + this.zCoord) % 200 == 0)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (entityplayer.openContainer instanceof ContainerJenChest)
                {
                    IInventory iinventory = ((ContainerJenChest)entityplayer.openContainer).getLowerChestInventory();

                    if (iinventory == this || iinventory instanceof InventoryLargeJenChest && ((InventoryLargeJenChest)iinventory).isPartOfLargeChest(this))
                    {
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof blockJenChest))
            {
                return 0;
            }

            this.cachedChestType = ((blockJenChest)this.getBlockType()).field_149956_a;
        }
