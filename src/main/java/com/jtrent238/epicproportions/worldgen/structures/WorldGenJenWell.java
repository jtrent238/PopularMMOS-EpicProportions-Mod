...
public class WorldGenJenWell extends WorldGenerator implements IWorldGenerator
{
    ...
    public void generate(Random random, int i2, int k2, World world, IChunkProvider chunkGenerator,
		...
		System.out.println(EpicProportionsMod.MODID + ">> SuperGirlyGamer Well Structure Generated at: " + i2 + "," + k2);
