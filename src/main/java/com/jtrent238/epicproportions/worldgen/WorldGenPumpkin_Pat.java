...
public class WorldGenPumpkin_Pat extends WorldGenerator
{
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        for (int l = 0; l < 64; ++l)
        {
            ...
            if (p_76484_1_.isAirBlock(i1, j1, k1) && p_76484_1_.getBlock(i1, j1 - 1, k1) == Blocks.grass && BlockLoader.BlockPumpkinPat.canPlaceBlockAt(p_76484_1_, i1, j1, k1))
            {
                p_76484_1_.setBlock(i1, j1, k1, BlockLoader.BlockPumpkinPat, p_76484_2_.nextInt(4), 2);
            }
        }
