...
import com.jtrent238.epicproportions.entity.ai.EntityAIKittySit;
...
*/
    ...
    public EntityKitty createChild(EntityAgeable p_90011_1_)
    {
    	EntityKitty entitykitty = new EntityKitty(this.worldObj);

        if (this.isTamed())
        {
        	entitykitty.func_152115_b(this.func_152113_b());
            entitykitty.setTamed(true);
            entitykitty.setTameSkin(this.getTameSkin());
        }
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        if (this.worldObj.rand.nextInt(7) == 0)
        {
            ...
            {
                EntityKitty entitykitty = new EntityKitty(this.worldObj);
                entitykitty.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
                entitykitty.setGrowingAge(-24000);
                this.worldObj.spawnEntityInWorld(entitykitty);
            }
        }
