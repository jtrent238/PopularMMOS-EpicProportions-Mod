...
public class EntityEpicProportionsPainting extends EntityHanging
{
    public EntityEpicProportionsPainting.EnumArt art;
    ...
    public EntityEpicProportionsPainting(World p_i1600_1_, int p_i1600_2_, int p_i1600_3_, int p_i1600_4_, int p_i1600_5_)
    {
        ...
        EntityEpicProportionsPainting.EnumArt[] aenumart = EntityEpicProportionsPainting.EnumArt.values();
        int i1 = aenumart.length;

        for (int j1 = 0; j1 < i1; ++j1)
        {
            EntityEpicProportionsPainting.EnumArt enumart = aenumart[j1];
            this.art = enumart;
        ...
        {
            this.art = (EntityEpicProportionsPainting.EnumArt)arraylist.get(this.rand.nextInt(arraylist.size()));
        }
    ...
    public EntityEpicProportionsPainting(World p_i1601_1_, int p_i1601_2_, int p_i1601_3_, int p_i1601_4_, int p_i1601_5_, String p_i1601_6_)
    {
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            EntityEpicProportionsPainting.EnumArt enumart = aenumart[j];
        ...
        if (this.art == null)
        {
            this.art = EntityEpicProportionsPainting.EnumArt.Kebab;
        }
