...
public class EntityAIKittySit extends EntityAIBase
{
    private final EntityKitty field_151493_a;
    ...
    public EntityAIKittySit(EntityKitty entityKitty, double p_i45315_2_)
    {
        this.field_151493_a = entityKitty;
    ...
    private boolean func_151486_a(World p_151486_1_, int p_151486_2_, int p_151486_3_, int p_151486_4_)
    {
        ...
        if (block == BlockLoader.blockPatChest)
        {
            TileEntityPatChest tileentitypatchest = (TileEntityPatChest)p_151486_1_.getTileEntity(p_151486_2_, p_151486_3_, p_151486_4_);

            if (tileentitypatchest.numPlayersUsing < 1)
            {
                return true;
            }
        }
        if (block == BlockLoader.blockJenChest)
        {
        	TileEntityJenChest tileentityjenchest = (TileEntityJenChest)p_151486_1_.getTileEntity(p_151486_2_, p_151486_3_, p_151486_4_);

            if (tileentityjenchest.numPlayersUsing < 1)
            {
                return true;
            }
        }
