...
public class EntityKami extends EntityLiving /*/extends EntityAnimal/*/ /*/implements IShearable/*/
{
    ...
    /*public static final float[][] fleeceColorTable = new float[][] {{0F, 100F, 0F}};
    /**
    ...
    public EntityKami(World p_i1691_1_)
    {
        super(p_i1691_1_);
...
*/
   ...
   /* public static int getRandomFleeceColor(Random p_70895_0_)
    ...
    public EntityKami createChild(EntityAgeable p_90011_1_)
    {
        EntityKami EntityKami = (EntityKami)p_90011_1_;
        EntityKami EntityKami1 = new EntityKami(this.worldObj);
        int i = this.func_90014_a(this, EntityKami);
        EntityKami1.setFleeceColor(15 - i);
        return EntityKami1;
    }
*/
    /**
...
*/
    ...
    private int func_90014_a(EntityAnimal p_90014_1_, EntityAnimal p_90014_2_)
    {
        ...
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.field_90016_e, ((EntityKami)p_90014_1_).worldObj);
        int k;
    ...
    {
        return 15 - ((EntityKami)p_90013_1_).getFleeceColor();
    }
