...
public class EntityClown  extends EntityMob
{
...
/*
            SummonAidEvent summonAid = ForgeEventFactory.fireZombieSummonAid(zombie, world, x, y, z, attacker, summonChance)(this, worldObj, i, j, k, entitylivingbase, this.getEntityAttribute(field_110186_bp).getAttributeValue());
...
*/
    ...
    {
        return "epicproportionsmod:clown_say";
    }
    ...
    {
        return "epicproportionsmod:clown_hurt";
    }
    ...
    {
        return "epicproportionsmod:clown_death";
    }
