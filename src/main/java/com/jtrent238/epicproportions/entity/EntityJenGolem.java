...
public class EntityJenGolem extends EntityGolem
{
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            this.func_145778_a(Item.getItemFromBlock(BlockLoader.blockJenIngot), 1, 0.0F);
        }
        ...
        for (int l = 0; l < k; ++l)
        {
            this.dropItem(ItemLoader.itemJenIngot, 1);
        }
    }
