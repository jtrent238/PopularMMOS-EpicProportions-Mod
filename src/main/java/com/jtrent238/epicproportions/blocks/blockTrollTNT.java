...
import com.jtrent238.epicproportions.entity.EntilyTrollTNTPrimed;
...
public class blockTrollTNT extends Block
{
    ...
    public void onBlockAdded(World p_149726_1_, int p_149726_2_, int p_149726_3_, int p_149726_4_)
    {
        ...
        if (p_149726_1_.isBlockIndirectlyGettingPowered(p_149726_2_, p_149726_3_, p_149726_4_))
        {
            ...
            this.playSoundAtEntity(EntityPlayer, "epicproportionsmod:fartbomb_3", 1.0F, 1.0F);
        }
        }
    private void playSoundAtEntity(Object entityPlayer2, String string, float f, float g) {
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
        	EntilyTrollTNTPrimed entitytntprimed = new EntilyTrollTNTPrimed(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.getExplosivePlacedBy());
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isRemote)
        {
            if ((p_150114_5_ & 1) == 1)
            {
            	EntilyTrollTNTPrimed entitytntprimed = new EntilyTrollTNTPrimed(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
