...
import com.jtrent238.epicproportions.dim.TeleporterEpic;
...
public class BlockEpicProportionsPortal extends BlockBreakable
{
	public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};
	@SuppressWarnings("unused")
	private static final String __OBFID = "CL_00000284";

	public BlockEpicProportionsPortal(String name)
	{
		super("epicproportionsmod:" + name, Material.portal, false);
		this.setTickRandomly(true);
		this.setBlockName(name);
		this.setBlockTextureName("epicproportionsmod:" + name);
	...
	public boolean getPortalSize(World world, int x, int y, int z) {
		BlockEpicProportionsPortal.Size size = new BlockEpicProportionsPortal.Size(world, x, y, z, 1);
		BlockEpicProportionsPortal.Size size1 = new BlockEpicProportionsPortal.Size(world, x, y, z, 2);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		if ((entity.ridingEntity == null) && (entity.riddenByEntity == null) && ((entity instanceof EntityPlayerMP))) {
			...
			if (thePlayer.timeUntilPortal > 0) {
				...
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, DimensionRegistry.dimensionId, new TeleporterEpic(thePlayer.mcServer.worldServerForDimension(DimensionRegistry.dimensionId)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterEpic(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
	...
	public static class Size
	{
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (block == BlockLoader.BlockEpicProportionsPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.worldObj.getBlock(k + Direction.offsetX[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockEpicProportionsPortal.field_150001_a[this.field_150865_b][1]];
		...
		protected boolean getBlockMaterial(Block block){
			return block.getMaterial() == Material.air || block == Blocks.fire || block == BlockLoader.BlockEpicProportionsPortal;
		}
	...
	public void tryTroCreatePortal(World par3World, int par4, int par5, int par6) {
