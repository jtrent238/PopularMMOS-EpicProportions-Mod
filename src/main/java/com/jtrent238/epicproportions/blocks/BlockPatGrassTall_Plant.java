...
public class BlockPatGrassTall_Plant extends BlockBush implements IGrowable, IShearable
{
    private static final String[] field_149871_a = new String[] {"tallgrass"};
    @SideOnly(Side.CLIENT)
    private IIcon[] field_149870_b;
    private static final String __OBFID = "CL_00000321";

    public BlockPatGrassTall_Plant()
    {
        super(Material.vine);
        float f = 0.4F;
