...
public class BlockModStem extends BlockBush implements IGrowable
{
    ...
    public BlockModStem(Block p_i45430_1_)
    {
    ...
    public void dropBlockAsItemWithChance(World p_149690_1_, int p_149690_2_, int p_149690_3_, int p_149690_4_, int p_149690_5_, float p_149690_6_, int p_149690_7_)
    {
        ...
        if (false && !p_149690_1_.isRemote)
        {
            ...
            if (this.field_149877_a == BlockLoader.BlockPumpkinPat)
            {
                item = ItemLoader.ItemPumpkinPat_Seeds;
            }

            if (this.field_149877_a == BlockLoader.BlockPumpkinJen)
            {
                item = ItemLoader.ItemPumpkinJen_Seeds;
            }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune)
    {
        ...
        Item item = null;
        item = field_149877_a == BlockLoader.BlockPumpkinPat ? ItemLoader.ItemPumpkinPat_Seeds : item;
        item = field_149877_a == BlockLoader.BlockPumpkinJen ? ItemLoader.ItemPumpkinJen_Seeds : item;
