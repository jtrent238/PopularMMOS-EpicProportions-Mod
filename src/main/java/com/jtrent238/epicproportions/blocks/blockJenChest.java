...
import com.jtrent238.epicproportions.inventory.InventoryLargeJenChest;
...
public class blockJenChest extends BlockContainer
{
    ...
    @SideOnly(Side.CLIENT)
	 ...
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "0"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "1"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "2"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "3"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "4"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "5"));
	 list.add(EnumChatFormatting.RED + StatCollector.translateToLocal("tooltip." + EpicProportionsMod.MODID + "." + "blockJenChest" + "." + "Warning" + "." + "noinventory" + "." + "6"));
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityJenChest tileentitychest = (TileEntityJenChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
    ...
    {
    	TileEntityJenChest tileentitychest = (TileEntityJenChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
    ...
    {
        Object object = (TileEntityJenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeJenChest("container.chestJenDouble", (TileEntityJenChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeJenChest("container.chestJenDouble", (IInventory)object, (TileEntityJenChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeJenChest("container.chestJenDouble", (TileEntityJenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeJenChest("container.chestJenDouble", (IInventory)object, (TileEntityJenChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
    	TileEntityJenChest tileentitychest = new TileEntityJenChest();
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((TileEntityJenChest)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("epicproportionsmod:blockJenIngot");
    }
