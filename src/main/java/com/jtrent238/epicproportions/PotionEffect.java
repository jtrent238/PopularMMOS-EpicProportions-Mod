...
public class PotionEffect
{
    ...
    public boolean onUpdate(EntityLivingBase p_76455_1_)
    {
        if (this.duration > 0)
        {
            if (PotionLoader.potionTypes[this.potionID].isReady(this.duration, this.amplifier))
            {
    ...
    public void performEffect(EntityLivingBase p_76457_1_)
    {
        if (this.duration > 0)
        {
        	PotionLoader.potionTypes[this.potionID].performEffect(p_76457_1_, this.amplifier);
        }
    }

    public String getEffectName()
    {
        return PotionLoader.potionTypes[this.potionID].getName();
    }
    ...
    public String toString()
    {
        ...
        return PotionLoader.potionTypes[this.potionID].isUsable() ? "(" + s + ")" : s;
    }
    ...
    public static PotionEffect readCustomPotionEffectFromNBT(NBTTagCompound p_82722_0_)
    {
        ...
        if (b0 >= 0 && b0 < PotionLoader.potionTypes.length && PotionLoader.potionTypes[b0] != null)
        {
