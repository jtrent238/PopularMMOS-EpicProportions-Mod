...
public class ModelPatStatue extends ModelBase
{
    ...
    public ModelPatStatue()
    {
        this(0.0F);
    }

    public ModelPatStatue(float p_i1148_1_)
    {
        this(p_i1148_1_, 0.0F, 64, 32);
    }

    public ModelPatStatue(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_)
    {
