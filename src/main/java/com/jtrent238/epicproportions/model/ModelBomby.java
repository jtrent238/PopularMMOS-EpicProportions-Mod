...
public class ModelBomby extends ModelBase
{
    ...
    public ModelBomby(float p_i1147_1_)
    {
        byte b0 = 4;
    ...
    extends ModelBase
  {
    ...
    public ModelCreeperLegs()
    {
      this(0.0F);
    }
    
    public ModelCreeperLegs(float par1)
    {
      byte b0 = 4;
      this.leg1 = new ModelRenderer(this, 0, 16);
