...
public class ModelJenGolem extends ModelBase
{
    ...
    public ModelJenGolem()
    {
        this(0.0F);
    }

    public ModelJenGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelJenGolem(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
    	EntityJenGolem entityirongolem = (EntityJenGolem)p_78086_1_;
