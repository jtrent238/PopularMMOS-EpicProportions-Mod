...
public class ModelPatGolem extends ModelBase
{
    ...
    public ModelPatGolem()
    {
        this(0.0F);
    }

    public ModelPatGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelPatGolem(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
        EntityPatGolem entityirongolem = (EntityPatGolem)p_78086_1_;
