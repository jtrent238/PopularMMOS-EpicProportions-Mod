...
public class ModelCaptianCookieStatue extends ModelBase
{
    ...
    public ModelCaptianCookieStatue()
    {
        this(0.0F);
    }

    public ModelCaptianCookieStatue(float p_i1148_1_)
    {
        this(p_i1148_1_, 0.0F, 64, 32);
    }

    public ModelCaptianCookieStatue(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_)
    {
    ...
    public void renderModel(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        this.setRotationAngles(p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, p_78088_7_, p_78088_1_);
