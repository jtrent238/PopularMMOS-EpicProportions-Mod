...
public class ModelJenStatue extends ModelBase
{
    ...
    public ModelJenStatue()
    {
        this(0.0F);
    }

    public ModelJenStatue(float p_i1148_1_)
    {
        this(p_i1148_1_, 0.0F, 64, 32);
    }

    public ModelJenStatue(float p_i1149_1_, float p_i1149_2_, int p_i1149_3_, int p_i1149_4_)
    {
