package com.jtrent238.epicproportions.inventory;

import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.inventory.IInventory;
import net.minecraft.item.ItemStack;

public class InventoryLargeJenChest  implements IInventory
{
    /** Name of the chest. */
    private String name;
    ...
    public InventoryLargeJenChest(String p_i1559_1_, IInventory p_i1559_2_, IInventory p_i1559_3_)
    {
