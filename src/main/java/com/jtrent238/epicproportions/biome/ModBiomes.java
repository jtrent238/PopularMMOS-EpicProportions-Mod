...
import com.jtrent238.epicproportions.biome.decorators.BiomeDecoratorMod;
...
public class ModBiomes extends BiomeGenBase {
    ...
    public static BiomeGenBase pat;
    public static BiomeGenBase jen;
    ...
    static {
        pat = (new BiomeGenPat(BiomeIDs.PAT).setColor(5470985).setTemperatureRainfall(0.95F, 0.9F).setHeight(biomeHeight).setBiomeName("Forest Of Light"));
        jen = (new BiomeGenJen(BiomeIDs.JEN).setColor(34049320).setTemperatureRainfall(0.8F, 0.4F).setHeight(biomeHeight).setBiomeName("Darkness Forest"));
    }
    ...
    {
        BiomeDictionary.registerBiomeType(pat, Type.PLAINS);
        BiomeDictionary.registerBiomeType(jen, Type.PLAINS);
