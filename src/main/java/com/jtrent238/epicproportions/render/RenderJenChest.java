...
public class RenderJenChest extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntityJenChest p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof blockJenChest && i == 0)
            {
                try
                {
                ((blockJenChest)block).func_149954_e(p_147502_1_.getWorldObj(), p_147502_1_.xCoord, p_147502_1_.yCoord, p_147502_1_.zCoord);
                }
