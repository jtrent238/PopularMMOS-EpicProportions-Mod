...
public class TileEntityChestPatRenderer extends TileEntitySpecialRenderer
{

    private static final ResourceLocation field_147505_d = new ResourceLocation("epicproportionsmod:textures/entity/chest/pat_double.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation("epicproportionsmod:textures/entity/chest/pat.png");
    ...
    public TileEntityChestPatRenderer()
    {
    ...
    public void renderTileEntityAt(TileEntityPatChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        int i;
