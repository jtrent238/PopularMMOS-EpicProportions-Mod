...
public class RenderEpicProportionsPainting extends Render
{
    private static final ResourceLocation field_110807_a = new ResourceLocation(EpicProportionsMod.MODID + "textures/painting/paintings_epicproportions.png");
     ...
     */
    public void doRender(EntityEpicProportionsPainting p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
        ...
        EntityEpicProportionsPainting.EnumArt enumart = p_76986_1_.art;
        float f2 = 0.0625F;
     ...
     */
    protected ResourceLocation getEntityTexture(EntityEpicProportionsPainting p_110775_1_)
    {
        return field_110807_a;
    }

    private void func_77010_a(EntityEpicProportionsPainting p_77010_1_, int p_77010_2_, int p_77010_3_, int p_77010_4_, int p_77010_5_)
    {
    ...
    private void func_77008_a(EntityEpicProportionsPainting p_77008_1_, float p_77008_2_, float p_77008_3_)
    {
    ...
    {
        return this.getEntityTexture((EntityEpicProportionsPainting)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityEpicProportionsPainting)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}