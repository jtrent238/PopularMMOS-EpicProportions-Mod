...
public class WorldProviderEpicProportions extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderEpicProportions(this.worldObj, this.worldObj.getSeed(), true);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerEpicProportions(worldObj.getSeed(), terrainType);
		this.dimensionId = EpicProportionsMod.DIM_EPICPROPORTIONS;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(EpicProportionsMod.DIM_EPICPROPORTIONS);
	}
