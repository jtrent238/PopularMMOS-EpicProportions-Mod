...
public class WorldProviderEpic extends WorldProvider{
	...
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderEpic(this.worldObj, this.worldObj.getSeed(), true);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerEpic(worldObj.getSeed(), terrainType);
	...
	public String getSaveFolder() {
			return "EpicProportions"/* + DimensionRegistry.dimensionId*/;
	}
