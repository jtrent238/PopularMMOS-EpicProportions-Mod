...
import cpw.mods.fml.common.event.FMLPreInitializationEvent;
    ...
    public static void loadAchievements()
    {
    	...
    	achievementpat = new Achievement("achievement." + modid + ".iampat", "iampat", 0, 3, new ItemStack(ItemLoader.itemPatStatue), (Achievement)achievementinstall).initIndependentStat().registerStat();
    	achievementjen = new Achievement("achievement." + modid + ".iamjen", "iamjen", 0, 4, new ItemStack(ItemLoader.itemJenStatue), (Achievement)achievementinstall).initIndependentStat().registerStat();
