...
public class ChunkProviderWinterWonderLand implements IChunkProvider {
	...
	private EventType CAVE;
	private EventType RAVINE;
	private EventType SCATTERED_FEATURE;
	private net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType LAKE;
	private net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType LAVA;
	private net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType DUNGEON;
	private net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType ANIMALS;
	private net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType ICE;
	...
	public ChunkProviderWinterWonderLand(World world, long seed, boolean mapFeaturesEnabled)
	{
					...
					for (int l2 = 0; l2 < 8; ++l2) {
						...
						for (int i3 = 0; i3 < 4; ++i3) {
							...
							for (int k3 = 0; k3 < 4; ++k3) {
								if ((d15 += d16) > 0.0D) {
									blocks[j3 += short1] = Blocks.snow;//these can be set to custom blocks
								} else if (k2 * 8 + l2 < b0) {
									blocks[j3 += short1] = Blocks.ice;//these can be set to custom blocks
								} else {
