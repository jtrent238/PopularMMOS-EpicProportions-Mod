...
public class WorldChunkManagerWinterWonderLand extends WorldChunkManager {
	...
	public WorldChunkManagerWinterWonderLand()
	{
	...
	public WorldChunkManagerWinterWonderLand(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = WinterWonderLandGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerWinterWonderLand(World world)
	{
