...
public class TileEntityBlockChristmasPresents_Red extends TileEntity
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_145902_i : "container.present";
    }
    ...
    public static boolean func_145891_a(TileEntityBlockChristmasPresents_Red tileEntityBlockChristmasPresents_Red)
    {
        IInventory iinventory = func_145884_b(tileEntityBlockChristmasPresents_Red);
        ...
        if (iinventory != null)
        {
            ...
            if (iinventory instanceof ISidedInventory && b0 > -1)
            {
                ...
                {
                    if (func_145892_a(tileEntityBlockChristmasPresents_Red, iinventory, aint[k], b0))
                    {
                        return true;
                    }
                }
            ...
            else
            {
                ...
                for (int j = 0; j < i; ++j)
                {
                    if (func_145892_a(tileEntityBlockChristmasPresents_Red, iinventory, j, b0))
                    {
                        return true;
                    }
                }
        ...
        {
            EntityItem entityitem = func_145897_a(tileEntityBlockChristmasPresents_Red.getWorldObj(), tileEntityBlockChristmasPresents_Red.getXPos(), tileEntityBlockChristmasPresents_Red.getYPos() + 1.0D, tileEntityBlockChristmasPresents_Red.getZPos());

            if (entityitem != null)
            {
                return func_145898_a(tileEntityBlockChristmasPresents_Red, entityitem);
            }
        }
    ...
    private static boolean func_145892_a(TileEntityBlockChristmasPresents_Red tileEntityBlockChristmasPresents_Red, IInventory p_145892_1_, int p_145892_2_, int p_145892_3_)
    {
        ...
        if (itemstack != null && func_145890_b(p_145892_1_, itemstack, p_145892_2_, p_145892_3_))
        {
            ...
            ItemStack itemstack2 = func_145889_a(tileEntityBlockChristmasPresents_Red, p_145892_1_.decrStackSize(p_145892_2_, 1), -1);
    ...
    public static boolean func_145898_a(TileEntityBlockChristmasPresents_Red tileEntityBlockChristmasPresents_Red, EntityItem p_145898_1_)
    {
        boolean flag = false;
        ...
        else
        {
            ...
            ItemStack itemstack1 = func_145889_a(tileEntityBlockChristmasPresents_Red, itemstack, -1);
    ...
    private static ItemStack func_145899_c(TileEntityBlockChristmasPresents_Red tileEntityBlockChristmasPresents_Red, ItemStack p_145899_1_, int p_145899_2_, int p_145899_3_)
    {
        ItemStack itemstack1 = tileEntityBlockChristmasPresents_Red.getStackInSlot(p_145899_2_);

        if (func_145885_a((IInventory) tileEntityBlockChristmasPresents_Red, p_145899_1_, p_145899_2_, p_145899_3_))
        {
            boolean flag = false;
            ...
            if (itemstack1 == null)
            {
                ...
                int max = Math.min(p_145899_1_.getMaxStackSize(), tileEntityBlockChristmasPresents_Red.getInventoryStackLimit());
                if (max >= p_145899_1_.stackSize)
                {
                    tileEntityBlockChristmasPresents_Red.setInventorySlotContents(p_145899_2_, p_145899_1_);
                    p_145899_1_ = null;
                }
                else
                {
                    tileEntityBlockChristmasPresents_Red.setInventorySlotContents(p_145899_2_, p_145899_1_.splitStack(max));
                }
                flag = true;
            }
            ...
            if (flag)
            {
                if (tileEntityBlockChristmasPresents_Red instanceof TileEntityBlockChristmasPresents_Red)
                {
                    (tileEntityBlockChristmasPresents_Red).func_145896_c(8);
                    tileEntityBlockChristmasPresents_Red.markDirty();
                }
    ...
    public static IInventory func_145884_b(TileEntityBlockChristmasPresents_Red tileEntityBlockChristmasPresents_Red)
    {
        return func_145893_b(tileEntityBlockChristmasPresents_Red.getWorldObj(), tileEntityBlockChristmasPresents_Red.getXPos(), tileEntityBlockChristmasPresents_Red.getYPos() + 1.0D, tileEntityBlockChristmasPresents_Red.getZPos());
    }
