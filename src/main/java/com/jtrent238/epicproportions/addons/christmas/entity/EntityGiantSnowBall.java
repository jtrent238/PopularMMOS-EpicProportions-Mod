...
public class EntityGiantSnowBall extends EntityThrowable
{
    ...
    public EntityGiantSnowBall(World p_i1773_1_)
    {
        super(p_i1773_1_);
    }

    public EntityGiantSnowBall(World p_i1774_1_, EntityLivingBase p_i1774_2_)
    {
        super(p_i1774_1_, p_i1774_2_);
    }

    public EntityGiantSnowBall(World p_i1775_1_, double p_i1775_2_, double p_i1775_4_, double p_i1775_6_)
    {
