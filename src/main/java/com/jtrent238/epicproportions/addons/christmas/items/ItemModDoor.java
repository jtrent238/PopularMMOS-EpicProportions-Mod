...
import com.jtrent238.epicproportions.addons.christmas.DoorType;
...
public class ItemModDoor extends Item
{
	...
	protected static DoorType DoorType;
    private static final String __OBFID = "CL_00000020";

    public ItemModDoor(Material p_i45334_1_, DoorType dtype)
    {
        this.DoorType = dtype;
        this.maxStackSize = 1;
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
            ...
            if (this.DoorType == DoorType.gingerbread)
            {
                block = BlockLoader.BlockGingerBreadDoor;
            }
            if (this.DoorType == DoorType.peppermint)
            {
                block = BlockLoader.BlockPepperMintDoor;
            }
            else
            {
                block = Blocks.wooden_door;//Places a Plain Wooded door if a Mod one can't be placed.
            }
            		/*
