package com.jtrent238.epicproportions.addons.christmas.items.blockplacers;
...
public class ItemChristmasPresent extends itemBirthdayPresent{

    public ItemChristmasPresent()
    {
    ...
    @Override
	 ...
	 list.add(EnumChatFormatting.GOLD + StatCollector.translateToLocal("tooltip." + epicproportionsmod_christmas.MODID + "." + "ItemChristmasPresent" + "." + "xmas"));
	 list.add(EnumChatFormatting.ITALIC + StatCollector.translateToLocal("tooltip." + epicproportionsmod_christmas.MODID + "." + "ItemChristmasPresent" + "." + "inside"));
	  }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            BlockChristmasPresent present = (BlockChristmasPresent)BlockLoader.BlockChristmasPresent;
