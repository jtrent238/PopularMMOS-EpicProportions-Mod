...
public class BlockSnowman extends BlockContainer{
	...
	public BlockSnowman(Material material) {
        super(material);
    ...
    public TileEntity createNewTileEntity(World world, int par2) {
        return new TileEntityBlockSnowman();
    }
    
	public ItemStack getPickBlock(MovingObjectPosition target, World world, int x, int y, int z)
	  {
	    return new ItemStack(ItemLoader.ItemSnowman);
	  }
}
