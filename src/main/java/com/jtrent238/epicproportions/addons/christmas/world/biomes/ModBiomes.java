...
import com.jtrent238.epicproportions.addons.christmas.world.biomes.decorators.BiomeDecoratorMod;
...
public class ModBiomes extends BiomeGenBase {
    ...
    public static BiomeGenBase winterWonderland;
    ...
    static {
        winterWonderland = (new BiomeWinterWonderLand(BiomeIDs.WINTERWONDERLAND).setColor(5470985).setTemperatureRainfall(0.95F, 0.9F).setHeight(biomeHeight).setBiomeName("WinterWonderLandBiome"));
    }
    ...
    {
        BiomeDictionary.registerBiomeType(winterWonderland, Type.COLD);
