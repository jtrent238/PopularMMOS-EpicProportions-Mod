...
public class EntityXmasPainting extends EntityHanging
{
    public EntityXmasPainting.EnumArt art;
    private static final String __OBFID = "CL_00001556";

    public EntityXmasPainting(World p_i1599_1_)
    {
        super(p_i1599_1_);
    }

    public EntityXmasPainting(World p_i1600_1_, int p_i1600_2_, int p_i1600_3_, int p_i1600_4_, int p_i1600_5_)
    {
        super(p_i1600_1_, p_i1600_2_, p_i1600_3_, p_i1600_4_, p_i1600_5_);
        ArrayList arraylist = new ArrayList();
        EntityXmasPainting.EnumArt[] aenumart = EntityXmasPainting.EnumArt.values();
        int i1 = aenumart.length;

        for (int j1 = 0; j1 < i1; ++j1)
        {
            EntityXmasPainting.EnumArt enumart = aenumart[j1];
            this.art = enumart;
        ...
        {
            this.art = (EntityXmasPainting.EnumArt)arraylist.get(this.rand.nextInt(arraylist.size()));
        }
    ...
    public EntityXmasPainting(World p_i1601_1_, int p_i1601_2_, int p_i1601_3_, int p_i1601_4_, int p_i1601_5_, String p_i1601_6_)
    {
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            EntityXmasPainting.EnumArt enumart = aenumart[j];
        ...
        if (this.art == null)
        {
            this.art = EntityXmasPainting.EnumArt.Kebab;
        }
    ...
    public void onBroken(Entity p_110128_1_)
    {
        ...
        this.entityDropItem(new ItemStack(ItemLoader.ItemXmasPaintng), 0.0F);
    }
