package com.jtrent238.epicproportions.addons.christmas.items.spawners;
...
public class ItemSpawnXmasCapitanCookie extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityXmasCaptainCookie par1 = new EntityXmasCaptainCookie(world); //Just change"MyEntityCow" to any entity you would like to spawn
