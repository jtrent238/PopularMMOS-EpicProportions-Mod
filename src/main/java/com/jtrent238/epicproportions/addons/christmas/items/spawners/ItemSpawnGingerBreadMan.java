...
public class ItemSpawnGingerBreadMan extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntityGingerBreadMan par1 = new EntityGingerBreadMan(world); //Just change"MyEntityCow" to any entity you would like to spawn
