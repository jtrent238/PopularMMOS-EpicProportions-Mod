...
import com.jtrent238.epicproportions.addons.christmas.TradeHandler;
import com.jtrent238.epicproportions.addons.christmas.epicproportionsmod_christmas;

@SuppressWarnings("unchecked")
public class EntitySanta extends EntityVillager// implements IBossDisplayData, IMerchant, INpc
{
    ...
    public EntitySanta(World var1)
    {
        ...
        this.setCustomNameTag("Santa");
        //this.registerExtendedProperties(tradehandler, properties);
        addRandomArmor();
        DungeonHooks.addDungeonMob("Santa", 180);
        this.setProfession(64);
        this.registerVillageTradeHandler(64, new TradeHandler());
        this.getProfession();
	...
	public void registerRenderers(){
		RenderingRegistry.registerEntityRenderingHandler(EntitySanta.class, new RenderLiving(new ModelBiped(), 0){private int santa;
...
protected void dropRareDrop(int par1){
    ...
    {
    	this.entityDropItem(new ItemStack(ItemLoader.ItemCandyCane, 6), 0F);
        /*
    ...
    {
        return this.isTrading() ? "epicproportionsmod_christmas:Santa_MerryChristmas" : "epicproportionsmod_christmas:Santa_HoHoHo";
    }
    ...
    {
        return "epicproportionsmod_christmas:Santa_Hit";
    }
