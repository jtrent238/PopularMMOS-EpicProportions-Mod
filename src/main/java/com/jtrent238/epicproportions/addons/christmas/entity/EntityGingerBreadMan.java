...
public class EntityGingerBreadMan extends EntityGolem implements IBossDisplayData
{
	World world = null;
...
//this.dropItem(ItemLoader.itemJenStar, 1);
    ...
    {
    	this.entityDropItem(new ItemStack(ItemLoader.ItemGumDrop), 2F);
    	this.entityDropItem(new ItemStack(ItemLoader.ItemGingerBreadMan), 2F);
    ...
    {
        return "epicproportionsmod_christmas:GingerBreadMan_Hit";
    }
