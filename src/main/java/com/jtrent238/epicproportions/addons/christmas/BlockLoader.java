...
public class BlockLoader {
	...
	public static void loadBlocks() {
		...
		BlockFrostedGlass  = new BlockFrostedGlass(Material.glass, false).setBlockName("BlockFrostedGlass").setHardness(0.1F).setBlockTextureName("epicproportionsmod_christmas:BlockFrostedGlass").setStepSound(Block.soundTypeStone).setCreativeTab(epicproportionsmod_christmas.EpicProportionsMod_Christmas);
		...
		BlockBulb = new BlockBulb(Material.wood).setBlockName("BlockBulb" + "_" + ItemBulb.field_150923_a.length).setBlockTextureName("epicproportionsmod_christmas:BlockBulb" + "_" + ItemBulb.field_150923_a.length).setHardness(0F);//.setCreativeTab(epicproportionsmod_christmas.EpicProportionsMod_Christmas);
