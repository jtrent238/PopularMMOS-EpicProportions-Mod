...
public class BlockGingerBreadStairs extends Block
{
    ...
    protected BlockGingerBreadStairs(Block p_i45428_1_, int p_i45428_2_)
    {
        super(BlockLoader.BlockGingerBread.getMaterial());
    ...
    {
        return p_150148_0_ instanceof BlockGingerBreadStairs;
    }
