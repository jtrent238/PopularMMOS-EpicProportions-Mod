...
import com.jtrent238.epicproportions.addons.halloween.items.itemCandy;
...
public static void LoadItems() {
	...
	itemHalloweenPail_Pat = new itemHalloweenPail(1).setUnlocalizedName("itemHalloweenPail_Pat").setTextureName("epicproportionsmod_halloween:itemHalloweenPail_Pat").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemHalloweenPail_Jen = new itemHalloweenPail(2).setUnlocalizedName("itemHalloweenPail_Jen").setTextureName("epicproportionsmod_halloween:itemHalloweenPail_Jen").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemHalloweenPail_Creeper = new itemHalloweenPail(3).setUnlocalizedName("itemHalloweenPail_Creeper").setTextureName("epicproportionsmod_halloween:itemHalloweenPail_Creeper").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemHalloweenPail_Cow = new itemHalloweenPail(4).setUnlocalizedName("itemHalloweenPail_Cow").setTextureName("epicproportionsmod_halloween:itemHalloweenPail_Cow").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_0 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_0").setTextureName("epicproportionsmod_halloween:itemCandy_0").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_1 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_1").setTextureName("epicproportionsmod_halloween:itemCandy_1").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_2 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_2").setTextureName("epicproportionsmod_halloween:itemCandy_2").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_3 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_3").setTextureName("epicproportionsmod_halloween:itemCandy_3").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_4 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_4").setTextureName("epicproportionsmod_halloween:itemCandy_4").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_5 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_5").setTextureName("epicproportionsmod_halloween:itemCandy_5").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_6 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_6").setTextureName("epicproportionsmod_halloween:itemCandy_6").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_7 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_7").setTextureName("epicproportionsmod_halloween:itemCandy_7").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_8 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_8").setTextureName("epicproportionsmod_halloween:itemCandy_8").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_9 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_9").setTextureName("epicproportionsmod_halloween:itemCandy_9").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_10 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_10").setTextureName("epicproportionsmod_halloween:itemCandy_10").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_11 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_11").setTextureName("epicproportionsmod_halloween:itemCandy_11").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_12 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_12").setTextureName("epicproportionsmod_halloween:itemCandy_12").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_13 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_13").setTextureName("epicproportionsmod_halloween:itemCandy_13").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_14 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_14").setTextureName("epicproportionsmod_halloween:itemCandy_14").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_15 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_15").setTextureName("epicproportionsmod_halloween:itemCandy_15").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_16 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_16").setTextureName("epicproportionsmod_halloween:itemCandy_16").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_17 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_17").setTextureName("epicproportionsmod_halloween:itemCandy_17").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_18 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_18").setTextureName("epicproportionsmod_halloween:itemCandy_18").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_19 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_19").setTextureName("epicproportionsmod_halloween:itemCandy_19").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_20 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_20").setTextureName("epicproportionsmod_halloween:itemCandy_20").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_21 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_21").setTextureName("epicproportionsmod_halloween:itemCandy_21").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
	itemCandy_22 = new itemCandy(22, 22, false).setUnlocalizedName("itemCandy_22").setTextureName("epicproportionsmod_halloween:itemCandy_22").setCreativeTab(epicproportionsmod_halloween.EpicProportionsMod_Halloween);
