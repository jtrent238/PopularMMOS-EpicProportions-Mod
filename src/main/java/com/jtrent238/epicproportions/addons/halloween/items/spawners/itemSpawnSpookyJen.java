...
public class itemSpawnSpookyJen       extends Item
{
  ...
  //This allows Right Click to spawn entity
    ...
    if(!world.isRemote)
    {
    	EntitySpookyJen par1 = new EntitySpookyJen(world); //Just change"MyEntityCow" to any entity you would like to spawn
