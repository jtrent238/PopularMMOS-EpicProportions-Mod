...
public class EntitySpookyPat extends EntityGolem implements IBossDisplayData
{
	World world = null;
...
this.dropItem(com.jtrent238.epicproportions.ItemLoader.itemPatSword, 1);
this.dropItem(com.jtrent238.epicproportions.ItemLoader.itemPatStar, 1);
}
    ...
    {
    	this.entityDropItem(new ItemStack(com.jtrent238.epicproportions.ItemLoader.itemPatIngot), 2F);
    	this.entityDropItem(new ItemStack(com.jtrent238.epicproportions.ItemLoader.itemPatmeat_raw), 2F);
    	this.entityDropItem(new ItemStack(ItemLoader.itemHalloweenPail_Pat), 2F);
