package com.jtrent238.epicproportions.addons.halloween.gui;
...
public class GuiPailInventory extends GuiContainer
{
	 ...
	 */
	private static final ResourceLocation iconLocation = new ResourceLocation("inventoryitemmod", "textures/gui/inventorypail.png");

	/** The inventory to render on screen */
	private final InventoryPail inventory;

	public GuiPailInventory(ContainerPail containerItem)
	{
		super(containerItem);
